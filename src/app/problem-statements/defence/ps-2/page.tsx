...
export const metadata: Metadata = constructMetadata({
  title:
    "Offline-First Navigation Aid for Counter-Insurgency Patrols - Smart ABES Hackathon",
  description:
    ...
    <div className="max-w-4xl mx-auto px-6 py-12 select-text">
      ...
      <section className="mt-8">
        ...
        <ul className="list-disc list-inside ml-4 mb-4 space-y-2">
          ...
          <li>
            The Threat: Insurgents possess superior knowledge of the local
            terrain.
          </li>
          <li>
          ...
          <li>Stakes: One wrong turn could be fatal.</li>
        </ul>
        ...
        <ul className="list-disc list-inside ml-4 mb-4 space-y-2">
          <li>
            Routing Strategy: Explain how the routing algorithm balances safety
            versus speed.
          </li>
          <li>
            Error Handling: Address how the system manages accumulated
            positioning error.
          </li>
          <li>
            User Experience: Demonstrate how soldiers will use the system
            effectively while under stress and in the dark.
          </li>
          <li>
            Connectivity: Explain how peer-to-peer sharing functions without
