...
export const metadata: Metadata = constructMetadata({
  title: "Predictive Intelligence Fusion System for Counter-Insurgency- Smart ABES Hackathon",
  description:
    ...
    <div className="max-w-4xl mx-auto px-6 py-12 select-text">
      ...
      <section className="mt-8">
        ...
        <ul className="list-disc list-inside ml-4 mb-4 space-y-2">
          ...
          <li>
            Operational Environment: Counter-insurgency operations span 2,000 sq km 
            where insurgents blend into a civilian population of 50,000.
          </li>
          <li>
        ...
        <p className="text-gray-700 mb-4 leading-relaxed">
          Build a Predictive Intelligence Fusion System that synthesizes multiple 
          data streams to anticipate threats before they materialize.
        </p>
        <h2 className="text-2xl font-semibold mb-4">Key Requirements to Address</h2>
        <ul className="list-disc list-inside ml-4 mb-4 space-y-2">
          <li>Pattern Recognition: Explain how the system will detect patterns that human analysts miss.</li>
          <li>Data Reliability: Detail measures to prevent over-reliance on false or deceptive intelligence.</li>
          <li>Explainability: The system must be able to explain why a specific route is classified as risky.</li>
          <li>Adversarial Adaptation: Address how the system handles scenarios where insurgents adapt their tactics in response to the system.</li>
          <li>Failure Mode Resolution: Demonstrate the resolution of at least one critical intelligence failure mode.</li>
        </ul>
